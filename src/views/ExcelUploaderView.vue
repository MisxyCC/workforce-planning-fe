<template>
  <div class="flex items-start p-4 border-b bg-white sticky top-0 z-10 shadow-sm h-16">
    <SidebarTrigger />
    ...
    <Breadcrumb>
      <BreadcrumbList>
        ...
        <BreadcrumbItem>
          <BreadcrumbPage>{{ EXCEL_UPLOADER_EMPLOYEES }}</BreadcrumbPage>
        </BreadcrumbItem>
      </BreadcrumbList>
    </Breadcrumb>
  </div>
...
import { APP_NAME, EXCEL_UPLOADER_EMPLOYEES } from '@/constants';
